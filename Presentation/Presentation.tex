...
\begin{itemize}
\item \textbf{Statistical ensemble}: a large number of virtual copies of a system ; each of them  is a possible state of the real system. It is the formalization of a repeated experiment proposed by Gibbs
